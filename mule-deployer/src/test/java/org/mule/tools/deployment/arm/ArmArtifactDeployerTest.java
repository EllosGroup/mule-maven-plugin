...
public class ArmArtifactDeployerTest {
  ...
  public void setUp() throws DeploymentException {
    ...
    when(clientMock.findApplicationId((ApplicationMetadata) any())).thenReturn(FAKE_APPLICATION_ID);
  ...
  public void isFailIfNotExistsNotSetTest() {
    when(deploymentMock.isFailIfNotExists()).thenReturn(null);
  ...
  public void isFailIfNotExistsSetFalseTest() {
    when(deploymentMock.isFailIfNotExists()).thenReturn(false);
  ...
  public void isFailIfNotExistsSetTrueTest() {
    when(deploymentMock.isFailIfNotExists()).thenReturn(true);
